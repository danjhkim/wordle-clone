...
function intialize() {
	...
	for (let i = 0; i < keyboard.length; i++) {
		...
		keyboardRow.classList.add(i);

		if (keyboardRow.classList.contains(1)) {
			keyboardRow.classList.add('centerer');
		}
	...
	for (let c = 0; c < width; c++) {
		...
		currTile.addEventListener(
			...
			() => {
				...
				if (correct == width) {
					for (let c = 0; c < width; c++) {
						let thisTile = document.getElementById(
							(row - 1).toString() + '-' + c.toString(),
						);
						setTimeout(() => {
							thisTile.classList.add('dance');
							thisTile.addEventListener(
								'animationend',
								() => {
									thisTile.classList.remove('dance');
								},
								{ once: true },
							);
						}, (c * FLIP_ANIMATION_DURATION) / 5);
					}
		...
		setTimeout(() => {
			...
			console.log((c * FLIP_ANIMATION_DURATION) / 2);
		}, (c * FLIP_ANIMATION_DURATION) / 2);
	}
